...
import com.example.ticketnew.adapter.EventAdapter;
import com.example.ticketnew.adapter.EventNewAdapter;
...
//            try {
//                KeystoreUtil.generateRSAKeyPairIfNeeded(); // Đảm bảo cặp khóa được tạo nếu cần
//            } catch (Exception e) {
//                throw new RuntimeException(e);
//            }
//            try {
//                PublicKey rsaPublicKey = KeystoreUtil.getPublicKey(); // Lấy khóa công khai
//                int userint = Integer.parseInt(userId);
//                // Gọi DataManager để lưu public key vào cơ sở dữ liệu
//                DataManager.savePublicKey(this, userint, rsaPublicKey, new DataManager.SavePublicKeyCallback() {
//                    @Override
//                    public void onSuccess(String message) {
//                        // Xử lý khi thành công
//                        Log.d("Save Public Key", message);
//                    }
//
//                    @Override
//                    public void onError(String error) {
//                        // Xử lý khi có lỗi
//                        Log.e("Save Public Key", error);
//                    }
//                });
//
//            } catch (Exception e) {
